...
The component diagram shows the present implementation for postcode and history high-level overview
```ascii
...
`root@tiogapass:~#root@tiogapass:~# ls -l  /var/lib/phosphor-post-code-manager/`
...
`root@tiogapass:~#busctl call xyz.openbmc_project.State.Boot.PostCode /xyz/openbmc_project/State xyz.openbmc_project.State.Boot.PostCode GetPostCodes q 1`

`at 20 5 6 183 97 154 104 121 213 151 178 156 146 192 193 173 132 132 227 0 0`

`root@tiogapass:~#busctl call xyz.openbmc_project.State.Boot.PostCode /xyz/openbmc_project/State xyz.openbmc_project.State.Boot.PostCode GetPostCodes q 2`

`at 26 1 2 2 3 3 4 5 6 5 6 183 97 154 104 121 213 151 178 156 146 192 193 173 132 132 0`

`root@tiogapass:~#busctl call xyz.openbmc_project.State.Boot.PostCode /xyz/openbmc_project/State xyz.openbmc_project.State.Boot.PostCode GetPostCodes q 3`
...
##  fb-ipmi-oem
 ...
 - Send extracted postcode to fb-yv2-misc by dbus callback method registered in fb-yv2-misc(xyz.openbmc_project.Misc.Ipmi.Update).
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbMTQwMTU0NTY4NywxNTIyNDA4MDQyXX0=
-->