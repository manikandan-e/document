...
| | phosphor-host-postd                |    |             | selection switch  |
| |   (ipmi snoop)                     +---------+        |                   |
| | xyz.openbmc_project.State.         <------+  |        +-------------------+
...
**Host discovery**
 ...
 - Read each hosts postcode from Platform Specific OEM ServicesIPMI OEM handler(fb-ipmi-oem, intel-ipmi-oem,etc) postcode interrupt handler.
...
<!--stackedit_data:
eyJoaXN0b3J5IjpbNDc1Nzk4OTgyLDcxNTY0NjQ3NF19
-->